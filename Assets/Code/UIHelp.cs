...
/// <summary>
/// Help fucntions for generating GUI
/// </summary>
static class UIHelp {
    ...
    public static Image addImage(RectTransform rect, Color color, Sprite sprite = null, bool sliced=true, bool filled=true)
    {
    ...
    {
        RectTransform childRect = UIHelp.buildUIObject("TextChild", rect);
    ...
    {
        RectTransform childRect = UIHelp.buildUIObject("TextChild", rect, min, max, new Vector2(.5f, .5f));
    ...
    public static InputField addInputField(RectTransform rect, Color textColor, Font font, string initialText = "")
    {
        UIHelp.addImage(rect, new Color(.5f, .5f, .5f));
        Text target = UIHelp.addTextChild(rect, textColor, font, new Vector2(.05f, 0f), new Vector2(1f, 1f));
